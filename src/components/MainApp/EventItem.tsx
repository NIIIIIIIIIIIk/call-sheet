    ...
    <div className={styles.eventItem}>
      <div className={styles.eventHeader}>
        ...
        <div className={styles.eventActions}>
          ...
          >
            ...
            <option value="НЕ_ПРИЕМЛЕМО">✗ НЕ ПРИЕМЛЕМО</option>
          </select>
          <Button variant="ghost" size="small" onClick={handleDelete} title="Удалить сцену">
            ×
          </Button>
        </div>
      </div>
      ...
      <div className={styles.eventBody}>
        ...
        <div className={styles.eventMeta}>
          <span className={styles.label}>ADDED BY:</span> {event.addedBy === 'NIK' ? ' NIK' : ' ELINA'}
        </div>
      </div>
